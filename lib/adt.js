...
/**
 * Conjunto de declaraciones del lenguaje el orden no importa para determinar al
...
class For extends Expresion {
    ...
    generateSymbolTable(symboltable) {
        this.symbolTable = new SymbolTable();
        this.symbolTable.father = symboltable;
        this.symbolTable.addToSymbol(this.element, null);
        this.block.generateSymbolTable(this.symbolTable);
    }
}

class Lambda extends FunctionDecl {
}
